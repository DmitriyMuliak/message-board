...
const LoginFormTestKit = ({ overrideProps }: LoginFormTestKitParams = defaultTestKitParams) => {
  const defaultProps = {};
  const testMethods = {
...
type LoginFormField = keyof typeof FIELD_LABELS;

const createLoginFormDriver = ({ rootTestId } = { rootTestId: 'login-form' }) => {
